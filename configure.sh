...
[[ ":$PATH:" != *":${LARCV_BINDIR}:"* ]] && PATH="${LARCV_BINDIR}:${PATH}"
[[ ":$PATH:" != *":${LARCV_BASEDIR}/bin:"* ]] && PATH="${LARCV_BASEDIR}/bin:${PATH}"
[[ ":$LD_LIBRARY_PATH:" != *":${LARCV_LIBDIR}:"* ]] && LD_LIBRARY_PATH="${LARCV_LIBDIR}:${LD_LIBRARY_PATH}"
[[ ":$DYLD_LIBRARY_PATH:" != *":${LARCV_LIBDIR}:"* ]] && DYLD_LIBRARY_PATH="${LARCV_LIBDIR}:${DYLD_LIBRARY_PATH}"
...
[[ ":$PYTHONPATH:" != *":${LARCV_BASEDIR}/python:"* ]] && PYTHONPATH="${LARCV_BASEDIR}/python:${PYTHONPATH}"
